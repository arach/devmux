...
final class PermissionChecker: ObservableObject {
    ...
    /// which adds devmux to the Accessibility list and asks the user to toggle it on.
    ...
    /// which adds devmux to the Screen Recording list. The user toggles it on in Settings.
